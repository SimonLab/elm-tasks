...
var $author$project$Main$itemsDecoder = A2(
	$elm$json$Json$Decode$field,
	'data',
	$elm$json$Json$Decode$list($author$project$Main$itemDecoder));
var $author$project$Main$getItems = $elm$http$Http$get(
	{
		aw: A2($elm$http$Http$expectJson, $author$project$Main$GotItems, $author$project$Main$itemsDecoder),
		aP: 'https://goalsandtasks.herokuapp.com/api/tasks'
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$checked(complete)
					]),
				_List_Nil),
		...
		as: function () {
			switch (model.$) {
				case 0:
					return _List_fromArray(
						[
							$elm$html$Html$text('Loading tasks...')
						]);
				case 1:
					var items = model.a;
					return _List_fromArray(
						[
							$elm$html$Html$text('List of tasks:'),
							A2(
							$elm$html$Html$ul,
							_List_Nil,
							A2(
								$elm$core$List$map,
								function (i) {
									return $author$project$Main$viewLink(i);
								},
								items))
						]);
				default:
					return _List_fromArray(
						[
							$elm$html$Html$text('Sorry something wrong happend')
						]);
			}
		}(),
		aN: 'Tasks'
